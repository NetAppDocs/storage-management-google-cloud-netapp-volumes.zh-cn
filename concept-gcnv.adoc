...
NOTE: 要开始使用Google Cloud NetApp Volumes，您必须拥有相应的权限，并且Google Cloud NetApp Volumes管理员或 Google Cloud NetApp查看者角色已分配给您。link:task-add-roles.html["为NetApp Volumes 分配访问角色"^]。

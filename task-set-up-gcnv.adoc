...
summary: NetApp控制台需要通过 Google Cloud 服务帐户访问Google Cloud NetApp Volumes API 并获得正确的权限。 
---
...
[role="lead"]
NetApp控制台需要通过 Google Cloud 服务帐户获得正确的权限。



== 设置服务帐户

完成以下任务，以便NetApp控制台可以访问您的 Google Cloud 项目：
